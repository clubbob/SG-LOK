...
export const INVENTORY_SEED_VERSION = 4;
...
export const INITIAL_TUBE_BUTT_WELD_PRODUCTS: InventoryProduct[] = [
  buildProductLine('Tube Butt Weld Elbow (TBW)', '/inventory/micro-elbow-hme.png', 'TBW'),
];

export const INITIAL_METAL_FACE_SEAL_PRODUCTS: InventoryProduct[] = [
  buildProductLine('Metal Face Seal Elbow (MFS)', '/inventory/micro-elbow-hme.png', 'MFS'),
];
