...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    // 대리점관리 통계 구독
    const dealerRef = collection(db, 'dealer_customers');
    const unsubscribeDealerCustomers = onSnapshot(
      dealerRef,
      (snapshot) => {
      ...
      (error) => {
        console.error('대리점관리 통계 조회 오류:', error);
      }
    );
    ...
    <div className="p-4 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-4 bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
            <Link href="/admin/dealer-customers" className="block h-full">
              <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-lg p-3 border border-teal-200 hover:shadow-md transition-all hover:scale-[1.02]">
                <div className="flex items-center justify-between">
                  <div>
            ...
            <Link href="/admin/dealer-customers?status=업체등록중" className="block h-full">
              <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg p-3 border border-amber-200 hover:shadow-md transition-all hover:scale-[1.02]">
                <div className="flex items-center justify-between">
                  <div>
            ...
            <Link href="/admin/dealer-customers?status=판매중" className="block h-full">
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-lg p-3 border border-emerald-200 hover:shadow-md transition-all hover:scale-[1.02]">
                <div className="flex items-center justify-between">
                  <div>
            ...
            <Link href="/admin/dealer-customers?status=거래중단중" className="block h-full">
              <div className="bg-gradient-to-br from-rose-50 to-rose-100 rounded-lg p-3 border border-rose-200 hover:shadow-md transition-all hover:scale-[1.02]">
                <div className="flex items-center justify-between">
                  <div>
