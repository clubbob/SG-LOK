...
export function ErpInventoryStatusView({ isLimitedView = false }: ErpInventoryStatusViewProps) {
  const PAGE_SIZE = 100;
...
export default function AdminErpInventoryStatusPage() {
  return <ErpInventoryStatusView />;
}
